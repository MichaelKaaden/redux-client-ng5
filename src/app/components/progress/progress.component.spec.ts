...
describe("ProgressComponent", () => {
  ...
  it(
    "should show an animation after DELAY if isLoading is true",
    fakeAsync(() => {
  ...
  it(
    "should reset showProgress as soon as isLoading is set to false",
    fakeAsync(() => {
      component.isLoading = true;
      fixture.detectChanges();
      tick(DEFAULT_DELAY + 1); // wait for setTimeout()
  ...
  it(
    "should respect an individual delay value",
    fakeAsync(() => {
      const delay = 500;
